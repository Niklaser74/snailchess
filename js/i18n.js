...
const dict = {
  sv: {
    ...
    'aria.left': 'Gå vänster', 'aria.right': 'Gå höger', 'aria.aimUp': 'Sikta upp', 'aria.aimDown': 'Sikta ner', 'aria.weapon': 'Byt vapen',
    'menu.aimSelf': 'Sikta själv i battle och kaos',
    'duel.fire': 'SKJUT', 'duel.yourShot': 'Ditt skott! ↑ ↓ siktar, ← → går, håll SKJUT för kraft.', 'duel.retreat': 'Kryp i skydd!',
    'moves.title': 'Drag',
    ...
    'help.3': '<b>Slag:</b> den slagna snigeln drar sig in i skalet och lämnar brädet. Ingen skjuter i snällt schack. I <b>battle light</b> spelas slaget upp som en duell som anfallaren alltid vinner. I <b>battle</b> måste anfallaren träffa: miss = pjäsen står kvar och turen går över, och missar räddningsskottet när du står i schack faller kungen. I <b>kaos</b> skjuter båda växelvis tills en faller; skadan sitter kvar på pjäsen (sprickor i skalet) till nästa duell, och faller anfallaren lämnar den brädet. Ingen ångra i kaos. I battle och kaos <b>siktar och skjuter du själv</b> (kan stängas av i menyn): ↑ ↓ siktar, ← → går, håll SKJUT för att ladda kraft. Du har 20 sekunder på dig.',
    ...
    'help.5': '<b>Snigelpost:</b> spela mot en kompis i egen takt. Skapa ett parti i menyn, skicka länken, dra när du hinner. Slå på notiser så säger telefonen till när det är din tur. Välj bäst av 3 eller 5 för en serie – färgerna byts varje parti, och efteråt kan du ta revansch.',
    'help.close': 'Stäng',
    'menu.mode': 'Spelläge', 'mode.gentle': 'Snällt schack – ingen skjuter',
    'mode.battle': 'Battle – anfallaren måste träffa, annars går turen över',
    'mode.kaos': 'Kaos – båda skjuter tills en faller, skadan sitter kvar',
    'kaos.lost': '{piece} föll i duellen och lämnar brädet. Turen går över.', 'kaos.both': 'Båda föll! Turen går över.',
    ...
    'mode.gentle.short': 'Snällt', 'mode.light.short': 'Battle light', 'mode.battle.short': 'Battle', 'mode.kaos.short': 'Kaos',
    'online.title': 'Snigelpost', 'online.blurb': 'Spela mot en kompis i egen takt, i det spelläge som är valt ovan. Skapa ett parti, skicka länken, dra när du hinner. Ni får en notis när det är er tur.',
    'online.name': 'Ditt namn', 'online.defaultName': 'Snäcka', 'online.create': 'Skapa parti', 'online.copy': 'Kopiera länk', 'online.copied': 'Kopierad!', 'online.share': 'Dela',
    'online.yourTurn': 'Din tur', 'online.theirTurn': 'Väntar på {name}', 'online.open': 'Väntar på att någon ansluter', 'online.finished': 'Klart',
    'online.vs': 'mot {name}', 'online.noOpponent': 'Ingen motståndare ännu', 'online.none': 'Inga partier ännu. Skapa ett och skicka länken till en kompis.',
    'online.inviteTitle': 'Bjud in en motståndare', 'online.inviteText': 'Skicka länken till en kompis. Du spelar Gul och kan göra ditt första drag redan nu.',
    'online.waitText': 'Du får en tur när {name} har dragit. Sidan uppdateras av sig själv.', 'online.sending': 'Skickar ditt drag…',
    'online.play': 'Spela', 'online.show': 'Visa', 'online.delete': 'Ta bort', 'online.loading': 'Hämtar…', 'online.resign': 'Ge upp', 'online.resignConfirm': 'Ge upp partiet?', 'online.claim': 'Kräv vinst (14 dagars tystnad)',
    'online.bestOf': 'Antal partier', 'bestOf.1': 'Ett parti', 'bestOf.3': 'Bäst av 3', 'bestOf.5': 'Bäst av 5',
    'series.short': 'parti {no} · bäst av {of} · {score}', 'series.draws': ', oavgjorda: {n}',
    'series.next': 'Ställning {score}. Nästa parti har börjat – du spelar {team}.',
    'series.won': 'Du vann serien {score}!', 'series.lost': 'Du förlorade serien {score}.', 'series.drawn': 'Serien slutade oavgjort {score}.',
    'over.next': 'Nästa parti', 'over.rematch': 'Revansch',
    'online.error': 'Något gick fel: {msg}', 'online.disabled': 'Snigelpost är inte tillgängligt just nu.',
    'over.youResigned': 'Du gav upp.', 'over.theyResigned': 'Motståndaren gav upp – du vann!', 'over.timeoutWon': 'Du tog hem vinsten efter 14 dagars tystnad.', 'over.timeoutLost': 'Motståndaren tog hem vinsten efter 14 dagars tystnad.',
    'push.ask': 'Notis när det är din tur', 'push.on': 'Notiser på', 'push.denied': 'Notiser blockerade i webbläsaren', 'push.install': 'Installera appen för notiser (iPhone)',
  ...
  en: {
    ...
    'aria.left': 'Walk left', 'aria.right': 'Walk right', 'aria.aimUp': 'Aim up', 'aria.aimDown': 'Aim down', 'aria.weapon': 'Change weapon',
    'menu.aimSelf': 'Aim and fire yourself in battle and chaos',
    'duel.fire': 'FIRE', 'duel.yourShot': 'Your shot! ↑ ↓ aims, ← → walks, hold FIRE for power.', 'duel.retreat': 'Take cover!',
    'moves.title': 'Moves',
    ...
    'help.3': '<b>Captures:</b> the captured snail withdraws into its shell and leaves the board. Nobody shoots in gentle chess. In <b>battle light</b> the capture is played as a duel the attacker always wins. In <b>battle</b> the attacker must hit: a miss means the piece stays and the turn passes, and if the rescue shot misses while you are in check, the king falls. In <b>chaos</b> both shoot in turn until one falls; damage stays on the piece (cracks in the shell) until its next duel, and if the attacker falls it leaves the board. No undo in chaos. In battle and chaos <b>you aim and fire yourself</b> (can be turned off in the menu): ↑ ↓ aims, ← → walks, hold FIRE to charge. You have 20 seconds.',
    ...
    'help.5': '<b>Snail Mail:</b> play a friend at your own pace. Create a game in the menu, send the link, move when you have a moment. Turn on notifications and your phone tells you when it is your turn. Pick best of 3 or 5 for a series – colours swap every game, and afterwards you can ask for a rematch.',
    'help.close': 'Close',
    'menu.mode': 'Game mode', 'mode.gentle': 'Gentle chess – nobody shoots',
    'mode.battle': 'Battle – the attacker must hit, or the turn passes',
    'mode.kaos': 'Chaos – both shoot until one falls, damage stays',
    'kaos.lost': 'The {piece} fell in the duel and leaves the board. The turn passes.', 'kaos.both': 'Both fell! The turn passes.',
    ...
    'mode.gentle.short': 'Gentle', 'mode.light.short': 'Battle light', 'mode.battle.short': 'Battle', 'mode.kaos.short': 'Chaos',
    'online.title': 'Snail Mail', 'online.blurb': 'Play a friend at your own pace, in the game mode chosen above. Create a game, send the link, move when you have a moment. You get a notification when it is your turn.',
    'online.name': 'Your name', 'online.defaultName': 'Snail', 'online.create': 'Create game', 'online.copy': 'Copy link', 'online.copied': 'Copied!', 'online.share': 'Share',
    'online.yourTurn': 'Your turn', 'online.theirTurn': 'Waiting for {name}', 'online.open': 'Waiting for someone to join', 'online.finished': 'Finished',
    'online.vs': 'vs {name}', 'online.noOpponent': 'No opponent yet', 'online.none': 'No games yet. Create one and send the link to a friend.',
    'online.inviteTitle': 'Invite an opponent', 'online.inviteText': 'Send the link to a friend. You play Yellow and can make your first move right away.',
    'online.waitText': 'You get a turn when {name} has moved. The page updates by itself.', 'online.sending': 'Sending your move…',
    'online.play': 'Play', 'online.show': 'Show', 'online.delete': 'Delete', 'online.loading': 'Loading…', 'online.resign': 'Resign', 'online.resignConfirm': 'Resign the game?', 'online.claim': 'Claim the win (14 days of silence)',
    'online.bestOf': 'Games', 'bestOf.1': 'One game', 'bestOf.3': 'Best of 3', 'bestOf.5': 'Best of 5',
    'series.short': 'game {no} · best of {of} · {score}', 'series.draws': ', drawn: {n}',
    'series.next': 'Score {score}. The next game has started – you play {team}.',
    'series.won': 'You won the series {score}!', 'series.lost': 'You lost the series {score}.', 'series.drawn': 'The series ended level {score}.',
    'over.next': 'Next game', 'over.rematch': 'Rematch',
    'online.error': 'Something went wrong: {msg}', 'online.disabled': 'Snail Mail is not available right now.',
    'over.youResigned': 'You resigned.', 'over.theyResigned': 'Your opponent resigned – you won!', 'over.timeoutWon': 'You claimed the win after 14 days of silence.', 'over.timeoutLost': 'Your opponent claimed the win after 14 days of silence.',
    'push.ask': 'Notify me when it is my turn', 'push.on': 'Notifications on', 'push.denied': 'Notifications are blocked in the browser', 'push.install': 'Install the app for notifications (iPhone)',
