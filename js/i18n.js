...
const dict = {
  sv: {
    ...
    'help.3': '<b>Slag:</b> den slagna snigeln drar sig in i skalet och lämnar brädet. Ingen skjuter i det här läget. Det är snällt schack.',
    ...
    'help.5': '<b>Kommer:</b> battle-lägen där slaget avgörs i en Snäckmageddon-duell, och Snigelpost mot en kompis i egen takt.',
    'help.close': 'Stäng',
    'menu.mode': 'Spelläge', 'mode.gentle': 'Snällt schack – ingen skjuter', 'mode.battle': 'Battle light – slag avgörs i en duell',
    'duel.title': '{attacker} anfaller {defender}', 'duel.skip': 'Hoppa över', 'duel.salt': 'Saltet tog {name}!',
  ...
  en: {
    ...
    'help.3': '<b>Captures:</b> the captured snail withdraws into its shell and leaves the board. Nobody shoots in this mode. This is gentle chess.',
    ...
    'help.5': '<b>Coming:</b> battle modes where a capture is settled in a Snailmageddon duel, and Snail Mail against a friend at your own pace.',
    'help.close': 'Close',
    'menu.mode': 'Game mode', 'mode.gentle': 'Gentle chess – nobody shoots', 'mode.battle': 'Battle light – captures are settled in a duel',
    'duel.title': '{attacker} attacks {defender}', 'duel.skip': 'Skip', 'duel.salt': 'The salt got {name}!',
