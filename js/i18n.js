...
const dict = {
  sv: {
    ...
    'help.5': '<b>Snigelpost:</b> spela mot en kompis i egen takt. Skapa ett parti i menyn, skicka länken, dra när du hinner. Slå på notiser så säger telefonen till när det är din tur.',
    'help.close': 'Stäng',
  ...
  en: {
    ...
    'help.5': '<b>Snail Mail:</b> play a friend at your own pace. Create a game in the menu, send the link, move when you have a moment. Turn on notifications and your phone tells you when it is your turn.',
    'help.close': 'Close',
