...
// Deliberately Snäckmageddon's key: the games share one origin and one Supabase
// project, so one sign-in per device serves both (Google/e-mail linking lives there).
